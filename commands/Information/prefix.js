    ...
    constructor(client) {
        super(client, {
            ...
            details: oneLine`
				...
				Only people with the Administrator or Manage Server permission can change the prefix!
			`,
    ...
    async run(msg, args) {
        ...
        if (msg.guild) {
            if (!msg.member.hasPermission("MANAGE_GUILD" && "ADMINISTRATOR") && !this.client.isOwner(msg.author)) {
                return msg.reply('Only people with the Administrator or Manage Server permission can change the prefix!');
            }
